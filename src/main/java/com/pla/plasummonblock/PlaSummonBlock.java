package com.pla.plasummonblock;
...
@Mod(PlaSummonBlock.MOD_ID)
public class PlaSummonBlock
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "plasummonblock";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public PlaSummonBlock() {
